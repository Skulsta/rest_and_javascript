...
class ReviewService {
  constructor() {
    this.reviews = [new Review(createId(), "Good stuff", 9, "e24"), new Review(createId(), "Fantastic movie", 8, "e8076")];
  }
  ...
  getReviewsForTvShow(tvShowId) {
    return this.reviews.find(review => review.relatedItemId == tvShowId);
  }
